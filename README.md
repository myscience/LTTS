...
the paper: Paolo Muratore, Cristiano Capone, Pier Stanislao Paolucci (2020) "*Target spike patterns enable efficient and biologically plausible learning for complex temporal tasks*" (currently *under review*). Please give credit to this paper if you use or mnodify the code in a derivative work.
